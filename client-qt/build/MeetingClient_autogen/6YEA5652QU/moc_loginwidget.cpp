...
QT_MOC_LITERAL(5, 59, 18), // "onSwitchToRegister"
QT_MOC_LITERAL(6, 78, 15) // "onSwitchToLogin"

    },
    "LoginWidget\0loginSuccess\0\0onLoginClicked\0"
    "onRegisterClicked\0onSwitchToRegister\0"
    "onSwitchToLogin"
};
...
void LoginWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginWidget::loginSuccess)) {
                *result = 0;
                return;
            }
        }
